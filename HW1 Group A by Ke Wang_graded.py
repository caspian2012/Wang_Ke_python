...
""" Question 1""" 
#Stuart- Very well documented. But the problem asks for a function that takes a file name.
...
#Stuart- You've hard coded 'sample.txt' into your function. Whatever file you pass
#to the function is overwritten by this, and if you do not have a 'sample.txt' it will
#give you an error.
...
""" Question 3"""
#Stuart- Good job, I like your chart on this one. Simple and ordered.
...
#Stuart- Here line becomes a filter object and no longer a string. Filters don't have
# a split attribute. you can put a list around a filter object to extract a list but each
#letter will be treated individually          
